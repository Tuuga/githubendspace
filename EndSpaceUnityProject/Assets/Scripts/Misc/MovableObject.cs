...
{
    //public event Action<MovableObject> OnButtonSelected;        // This event is triggered when the selection of the button has finished.
    ...
    private void HandleOut()
    {
        ...
        m_GazeOver = false;
        gameObject.GetComponent<ObjectMover>().isActive = false;
    }
    ...
    {
        gameObject.GetComponent<ObjectMover>().isActive = true;
    }
